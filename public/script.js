...
window.onload = () => {
    ...
    // Tambahkan ke icon bell (opsional)
    ...
    // Tambahkan ke icon history (opsional)
...
// --- NAVIGATION (UPDATED with Developer support) ---
function switchTab(tabName) {
    ...
    // 2. Hide semua view KECUALI target
...
function showInstallAlert() {
    alert("Fitur instalasi akan segera tersedia! Anda dapat menambahkan aplikasi ini ke layar beranda melalui menu browser.");
}
